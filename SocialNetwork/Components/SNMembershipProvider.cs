...
public class SNMembershipProvider : MembershipProvider
{
    ...
    public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
    {
        ...
        {
            AccountRepository _account = new AccountRepository();
            _account.CreateMembershipUser(username, password, email, isApproved);
    ...
    {
        AccountRepository _account = new AccountRepository();
        return _account.GetMembershipUser(username);
    }
    ...
    {
        AccountRepository _account = new AccountRepository();
        return _account.GetUserNameByEmail(email);
    }
    ...
    public override string ResetPassword(string username, string answer)
    {
        ...
        pass = _accountRepository.ResetPassword(username);
    ...
    public override bool ValidateUser(string username, string password)
    {
        ...
        return _account.ValidateUser(username, password);
    }
